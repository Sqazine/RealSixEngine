...
#define DEF(format)           \
    case GfxFormat::##format: \
        ...
        switch (format)
        {
            FormatDefines();
        default:
            REALSIX_LOG_ERROR(TEXT("Unsupported Format"));
...
#define DEF(filter)           \
    case GfxFilter::##filter: \
        ...
        switch (filter)
        {
            ...
            DEF(LINEAR);
        default:
            REALSIX_LOG_ERROR(TEXT("Unsupported Vulkan Filter"));
...
#define DEF(addressMode)                \
    case GfxAddressMode::##addressMode: \
        ...
        switch (addressMode)
        {
            ...
            DEF(CLAMP_TO_EDGE);
        default:
            REALSIX_LOG_ERROR(TEXT("Unsupported Vulkan Address Mode"));
...
#undef DEF
    ...
    VkIndexType ToVkIndexType(GfxIndexType type)
    {
        ...
        default:
            REALSIX_LOG_ERROR(TEXT("Unsupported Vulkan index type"));
    ...
    VkVertexInputRate GetVkVertexInput(GfxVertexInputType type)
    {
        ...
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown VertexInputType!"));
        }
    }
    ...
    VkAttachmentLoadOp ToVkAttachmentOp(GfxAttachmentLoadOp loadOp)
    {
        ...
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown AttachmentOp"));
            return VK_ATTACHMENT_LOAD_OP_DONT_CARE;
        }
    }
...
#define DEF(topology)                      \
    case GfxPrimitiveTopology::##topology: \
        ...
        switch (primitiveTopology)
        {
            ...
            DEF(PATCH_LIST);
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown Primitive Topology!"));
        }
#undef DEF
    }
    ...
    VkFrontFace ToVkFrontFace(GfxFrontFace frontFace)
    {
        ...
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown FrontFace!"));
        }
    }
    ...
    VkPolygonMode ToVkPolygonMode(GfxPolygonMode polygonMode)
    {
        ...
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown PolygonMode!"));
        }
    }
    ...
    VkCullModeFlags ToVkCullMode(GfxCullMode cullMode)
    {
        ...
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown CullMode"));
        }
    }
...
#define DEF(op)           \
    case GfxCompareOp::##op: \
        ...
        switch (compareOp)
        {
            ...
            DEF(ALWAYS);
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown GfxCompareOp"));
        }
