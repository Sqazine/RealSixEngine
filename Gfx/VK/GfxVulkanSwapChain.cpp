...
namespace RealSix
{
    ...
    {
        GfxVulkanCommandBuffer *cmdBuffer = GetCurrentVulkanBackCommandBuffer();
        ...
        {
            REALSIX_LOG_INFO(TEXT("Swap chain out of date, resizing..."));
            Resize(mWindow->GetSize());
            return;
        }
        else if (result != VK_SUCCESS && result != VK_SUBOPTIMAL_KHR)
        {
            REALSIX_LOG_ERROR(TEXT("Failed to acquire next image!"));
            return;
        }
    ...
    void GfxVulkanSwapChain::Present(const GfxVulkanSemaphore *waitFor)
    {
        ...
        {
            REALSIX_LOG_ERROR(TEXT("Failed to present swap chain!"));
        }
    }
    ...
    void GfxVulkanSwapChain::ObtainPresentQueue()
    {
        ...
        {
            REALSIX_LOG_ERROR(TEXT("No present queue found for the swap chain!"));
        }
