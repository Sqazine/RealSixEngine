...
namespace RealSix
{
    VkQueue QueryQueueByCommandType(IGfxDevice *device, GfxCommandType type)
    {
        ...
        default:
            REALSIX_LOG_ERROR(TEXT("Unknown GfxCommandType: {}"), static_cast<int>(type));
            return vulkanDevice->GetGraphicsQueue();
        }
    }
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::GRAPHICS, TEXT("BeginRenderPass can only be called on GRAPHICS command buffer!"));
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::GRAPHICS, TEXT("BindRasterPipeline can only be called on GRAPHICS command buffer!"));
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::COMPUTE, TEXT("BindComputePipeline can only be called on COMPUTE command buffer!"));
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::GRAPHICS, TEXT("BindVertexBuffer can only be called on GRAPHICS command buffer!"));
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::GRAPHICS, TEXT("BindIndexBuffer can only be called on GRAPHICS command buffer!"));
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::GRAPHICS, TEXT("DrawIndexed can only be called on GRAPHICS command buffer!"));
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::GRAPHICS, TEXT("Draw can only be called on GRAPHICS command buffer!"));
    ...
    {
        REALSIX_CHECK(mCommandType == GfxCommandType::COMPUTE, TEXT("Dispatch can only be called on COMPUTE command buffer!"));
