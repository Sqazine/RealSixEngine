...
{
    GfxVulkanBuffer *CreateStagingBuffer(IGfxDevice *device, size_t bufferSize, const void *data)
    {
        GfxVulkanBuffer *stagingBuffer = new GfxVulkanBuffer(device, bufferSize,
                                                             VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
                                                             VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);
        SetBufferData(stagingBuffer, bufferSize, data);
    ...
    GfxVulkanBuffer *CreateVertexBuffer(IGfxDevice *device, const GfxBufferDesc &gfxDesc)
    {
        ...
        stagingBuffer.reset(CreateStagingBuffer(device, gfxDesc.bufferSize, gfxDesc.data));
