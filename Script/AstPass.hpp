...
namespace RealSix::Script
{
    ...
    protected:
        ...
        virtual Stmt *ExecuteVarDecl(VarDecl *decl) { return decl; }
        virtual Stmt *ExecuteEnumDecl(EnumDecl *decl) { return decl; }
