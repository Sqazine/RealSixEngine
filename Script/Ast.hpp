...
namespace RealSix::Script
{
	...
	struct LiteralExpr : public Expr
	{
		...
		LiteralExpr(Token *tagToken, StringView value);
	...
	struct IdentifierExpr : public Expr
	{
		...
		IdentifierExpr(Token *tagToken, StringView literal);
	...
	struct PrefixExpr : public Expr
	{
		...
		PrefixExpr(Token *tagToken, StringView op, Expr *right);
		~PrefixExpr() override;
#ifndef NDEBUG
		String ToString() override;
#endif
	...
	struct InfixExpr : public Expr
	{
		...
		InfixExpr(Token *tagToken, StringView op, Expr *left, Expr *right);
		~InfixExpr() override;
#ifndef NDEBUG
		String ToString() override;
#endif
	...
	struct PostfixExpr : public Expr
	{
		...
		PostfixExpr(Token *tagToken, Expr *left, StringView op);
