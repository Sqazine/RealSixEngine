...
namespace RealSix::Script
{
	...
	void Object::Mark()
	{
		...
		if (ScriptConfig::GetInstance().IsDebugGC())
			REALSIX_LOG_INFO("(0x{}) mark: {}", (void *)this, ToString());
#endif
		marked = true;
...
#ifndef NDEBUG
		if (ScriptConfig::GetInstance().IsDebugGC())
			REALSIX_LOG_INFO("(0x{}) unMark: {}", (void *)this, ToString());
#endif
		marked = false;
	}
...
#ifndef NDEBUG
		if (ScriptConfig::GetInstance().IsDebugGC())
			REALSIX_LOG_INFO("(0x{}) blacken: {}", (void *)this, ToString());
#endif
	}

	StrObject::StrObject(StringView value)
	...
	{
		return "<fn " + name + ":0x" + PointerAddressToString((void *)this) + ">";
	}
#ifndef NDEBUG
	...
	ClassObject::ClassObject(StringView name)
