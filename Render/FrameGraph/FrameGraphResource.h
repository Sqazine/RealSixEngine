...
namespace RealSix
{
    ...
    {
    public:
        explicit FrameGraphResourceBase(std::string_view name, const FrameGraphRenderTaskBase *creator)
    ...
    public:
        ...
        explicit FrameGraphResource(std::string_view name, const FrameGraphRenderTaskBase *creator, const DescriptionType &description)
        ...
        explicit FrameGraphResource(std::string_view name, const DescriptionType &description, ActualType *actualData = nullptr)
