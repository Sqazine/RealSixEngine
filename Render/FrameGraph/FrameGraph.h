...
namespace RealSix
{
    ...
    public:
        ...
        bool RemoveRenderTask()
        {
            ...
            auto iter = std::find_if(mRenderTasks.begin(), mRenderTasks.end(), [](auto &renderTask)
                                     {
                                         std::string name = GetPrettyTypeName<PassType>();
        ...
        FrameGraphResource<DescriptionType, ActualType> *AddRetainedResource(std::string_view name, const DescriptionType &description, ActualType *actual = nullptr)
        {
        ...
        template <typename DescriptionType, typename ActualType>
        std::vector<FrameGraphResource<DescriptionType, ActualType> *> AddRetainedResource(std::string_view name, const DescriptionType &description, std::vector<ActualType *> &actuals = {})
        {
    ...
    protected:
        ...
        std::unordered_map<std::string_view, std::unique_ptr<FrameGraphResourceBase>> mResources;
