...
namespace GLResource
{
    ...
    using BufferResource = RealSix::Resource<BufferDesc, GL::Buffer>;
    using Texture1DResource = RealSix::Resource<TextureDescription, GL::Texture1D>;
    using Texture2DResource = RealSix::Resource<TextureDescription, GL::Texture2D>;
    using Texture3DResource = RealSix::Resource<TextureDescription, GL::Texture3D>;
}
...
int main(int argc, char *argv[])
{
    ...
    auto RenderTask1 = frameGraph.AddRenderTask<RenderTask1Pass>(
        false,
        [&](RenderTask1Pass *pass, RealSix::RenderTaskBuilder &builder)
        {
    ...
    auto RenderTask2 = frameGraph.AddRenderTask<RenderTask2Pass>(
        false,
        [&](RenderTask2Pass *pass, RealSix::RenderTaskBuilder &builder)
        {
    ...
    auto RenderTask3 = frameGraph.AddRenderTask<RenderTask3Pass>(
        false,
        [&](RenderTask3Pass *pass, RealSix::RenderTaskBuilder &builder)
        {
