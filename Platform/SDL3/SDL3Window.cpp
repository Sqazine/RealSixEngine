...
namespace RealSix
{
        ...
        : mHandle(nullptr), mIsShown(false), mTitle("RealSix")
    {
        ...
        case GfxBackend::D3D12:
            REALSIX_LOG_INFO(TEXT("D3D12 backend doesn't need Window flag in SDL3Window."));
            break;
        default:
            REALSIX_LOG_ERROR(TEXT("Unsupported GfxBackend: {}"), static_cast<int>(gfxConfig.GetBackend()));
            return;
        }
